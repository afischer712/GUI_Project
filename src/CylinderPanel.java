/**
 * 
 * This class creates the Panel of Geometry Calculator that takes in information for the cylinders and 
...
public class CylinderPanel extends JPanel{
	...
	/**
	 * this method constructs the Panel for Cylinder and calls the JPanel superconstructor
	 */
